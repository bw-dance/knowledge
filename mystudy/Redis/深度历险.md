...
详解：[mystudy/Redis/Redis数据结构详解.md · Zhang-HaoQi/Knowledge - 码云 - 开源中国 (gitee.com)](https://gitee.com/zhang-haoqi/knowledge/blob/develop/mystudy/Redis/Redis数据结构详解.md)
