...
![image-20211217205656455](https://mynotepicbed.oss-cn-beijing.aliyuncs.com/img/image-20211217205656455.png)
...
![image-20211217205855091](https://mynotepicbed.oss-cn-beijing.aliyuncs.com/img/image-20211217205855091.png)   
...
![image-20211217205917260](https://mynotepicbed.oss-cn-beijing.aliyuncs.com/img/image-20211217205917260.png)
...
![image-20211217205953717](https://mynotepicbed.oss-cn-beijing.aliyuncs.com/img/image-20211217205953717.png)

![image-20211217205935173](https://mynotepicbed.oss-cn-beijing.aliyuncs.com/img/image-20211217205935173.png)
...
![image-20211217210134166](https://mynotepicbed.oss-cn-beijing.aliyuncs.com/img/image-20211217210134166.png)

### 2、进行request的服务器配置

a)   

![image-20211217210156073](https://mynotepicbed.oss-cn-beijing.aliyuncs.com/img/image-20211217210156073.png)

b)   

![image-20211217210207207](https://mynotepicbed.oss-cn-beijing.aliyuncs.com/img/image-20211217210207207.png)

### 3、进行request2的服务器配置

a)   在创建一个服务器

![image-20211217210224054](https://mynotepicbed.oss-cn-beijing.aliyuncs.com/img/image-20211217210224054.png)
...
<body>
<form action="/login/ServletOne" method="post">
...
1.  cookie存储数据在客户端浏览器（存在服务器的数据较安全，存在客户端的浏览器不安全，所以cookie总是存一些不是很重要的信息）
