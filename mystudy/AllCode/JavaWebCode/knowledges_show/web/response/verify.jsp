...
<body>
<!--图片的点击切换-->
<img id="img" class="code-link" src="/servlet/reqs/verify">
<a id="change" class="code-link">看不清，换一张</a>
</body>
</html>
