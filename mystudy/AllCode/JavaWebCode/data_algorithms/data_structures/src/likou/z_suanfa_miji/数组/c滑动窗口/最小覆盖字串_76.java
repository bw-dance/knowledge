...
class Solution01 {
    public String minWindow(String s, String t) {
        ...
        int left = 0, right = 0, strStart = 0, windowLength = Integer.MAX_VALUE;
        //3.临界条件，右侧指针到尾
        while (right < s.length()) {
            ...
            while (checkNum(tMap) == true) {
                ...
                char redNum = s.charAt(left);
                if (tMap.containsKey(redNum)) {
        ...
        return windowLength == Integer.MAX_VALUE ? "" : s.substring(strStart, strStart + windowLength + 1);
    }
