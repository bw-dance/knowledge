...
2. 挂载部署
   1. ```java
      ...
      docker run -p 6300:6379 --name redis00 --privileged=true -v /opt/redis-share/m1//data:/data \
      -v /opt/redis-share/m1/conf/redis.conf:/etc/redis/redis.conf \
      -d redis redis-server /etc/redis/redis.conf --requirepass "121156"
          
      docker run -p 6301:6379 --name redis01 --privileged=true -v /opt/redis-share/v1/data:/data \
      -v /opt/redis-share/v1/conf/v1/redis.conf:/etc/redis/redis.conf \
      -d redis redis-server /etc/redis/redis.conf --requirepass "121156"
          
      docker run -p 6302:6379 --name redis02 --privileged=true -v /opt/redis-share/v2/data:/data \
      -v /opt/redis-share/v2/conf/redis.conf:/etc/redis/redis.conf \
      -d redis redis-server /etc/redis/redis.conf --requirepass "121156"
