...
```shell
docker run -d -p 15672:15672  -p  5672:5672  -e RABBITMQ_DEFAULT_USER=train -e RABBITMQ_DEFAULT_PASS=tarin@rabb --name rabbitmq --hostname=rabbitmqhostone  rabbitmq:management
```
...
3. 运行docker容器
   ...
   ```shell
   docker run -d -p 8848:8848 --name nacos --env MODE=standalone --env SPRING_DATASOURCE_PLATFORM=mysql   --env MYSQL_SERVICE_HOST=78.93.41.35    --env MYSQL_SERVICE_PORT=3306 --env MYSQL_SERVICE_DB_NAME=nacos_devtest_prod --env MYSQL_SERVICE_USER=root --env MYSQL_SERVICE_PASSWORD=123456 nacos/nacos-server:v2.0.4
   ```

3. 复制docker中的/home/nacos文件:`docker cp nacos:/home/nacos /mydata/nacos`
...
5. 重新运行一个nacos容器，挂载配置和日志
   ...
   --env MYSQL_SERVICE_HOST=39.96.41.35 \
   --env MYSQL_SERVICE_PORT=3306 \
   --env MYSQL_SERVICE_DB_NAME=nacos_devtest_prod \
   --env MYSQL_SERVICE_USER=root \
   --env MYSQL_SERVICE_PASSWORD=rtrain@2022 \
   -v /home/nacos/conf:/mydata/nacos/conf \
   -v /home/nacos/logs:/mydata/nacos/logs \
   -v /home/nacos/data:/mydata/nacos/data \
