...
public class Student {
    ...
    public Student(Integer id, String username, String password, String name, Long deptId, int age, Boolean sex, int height, LocalDateTime login_date) {
        this.id = id;
...
//添加学生
    private static void insertStudent(Student student) {
        ...
        try {
            ...
            preparedStatement.setDate(9, loginDate);
