...
使用Thread.yield()方法，暂停当前执行的线程对象，并执行其他线程。让当前运行的线程从运行状态返回到就绪状态。会考虑线程的优先级问题，如果当前线程yield之后，其他线程比当前线程的优先级低，那么当前线程会继续抢夺资源，如果其他线程和当前线程同级，优先让其他线程执行（当然，有时候也并不一定按照真正的优先级来。）
...
![image-20220118101110633](https://mynotepicbed.oss-cn-beijing.aliyuncs.com/img/image-20220118101110633.png)
...
[java 线程方法join的简单总结 - CoderLcp - 博客园 (cnblogs.com)](https://www.cnblogs.com/lcplcpjava/p/6896904.html)
